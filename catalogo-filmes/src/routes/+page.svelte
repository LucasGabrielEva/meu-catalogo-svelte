<script>
  ...
  const filmes = [
    ...
    { id: 10, titulo: 'Ben 10', genero: 'Ficção Científica', ano: 2005, nota: 9.0, emoji: '⌚', sinopse: 'acompanha Benjamin Tennyson, um garoto de 10 anos que encontra o Omnitrix, um relógio alienígena que lhe permite transformar-se em 10 heróis diferentes com habilidades únicas'},
    {id: 11, titulo: 'Hora de aventura', genero: 'animação', ano: 2010 , nota: 8.0, emoji: '💎', sinopse: 'acompanha as aventuras surrealistas de Finn, um garoto humano, e seu melhor amigo/irmão adotivo Jake, um cão com poderes elásticos, na Terra de Ooo, um cenário pós-apocalíptico mágico. Eles protegem os reinos de ameaças, principalmente do Rei Gelado, enquanto exploram ruínas de uma civilização antiga'},
    {id: 12, titulo: 'Apenas um Show', genero: 'animação', ano: 2010, nota: 9.0, emoji: '🦝', sinopse: 'acompanha Mordecai (um gaio-azul) e Rigby (um guaxinim), dois jardineiros de 23 anos que tentam fugir do trabalho e se divertir. Suas tentativas de preguiça geralmente escalam para aventuras surreais, sobrenaturais e perigosas, para a ira de seu chefe, a máquina de chicletes Benson'},
  ]
...
<style>
  ...
  h1 {
    font-size: 36px;
    margin-bottom: 4px;
    background: linear-gradient(135deg, #2ce725, #762ddb);
